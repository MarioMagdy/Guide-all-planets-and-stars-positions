...
t = 2459649.916666667 + (10/24) # Julian day for April 27, 2023, 10:00 AM UTC 
...
for planet in planets:
    ...
    print(f"Right Ascension: {math.degrees(equatorial_positions[planet][0]):.5f} deg")
    print(f"Declination: {math.degrees(equatorial_positions[planet][1]):.5f} deg")